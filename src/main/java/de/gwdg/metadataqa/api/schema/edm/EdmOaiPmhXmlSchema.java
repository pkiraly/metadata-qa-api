...
public class EdmOaiPmhXmlSchema extends EdmSchema implements Serializable {
  ...
  private void initialize() {
    ...
    var providedCHO = new DataElement("ProvidedCHO", "//edm:ProvidedCHO[1]");
    ...
    var proxy = new DataElement(
      "Proxy",
      "//ore:Proxy[edm:europeanaProxy/text() = 'false']"
    );
    proxy.setCollection(true);
    addPath(proxy);
    var proxyIdentifier = new DataElement("Proxy/rdf:about", proxy, "@rdf:about");
    ...
    addPath(aggregation);
    var aggregationIdentifier = new DataElement(
    ...
    addPath(place);
    var placeIdentifier = new DataElement("Place/rdf:about", place, "@rdf:about");
    ...
    var agentIdentifier = new DataElement("Agent/rdf:about", agent, "@rdf:about");
    ...
    var timespanIdentifier = new DataElement(
    ...
    var conceptIdentifier = new DataElement(
    ...
    var europeanaAggregation = new DataElement(
        "EuropeanaAggregation", "//edm:EuropeanaAggregation"
      )
      .setActive(false);
    europeanaAggregation.setCollection(true);
    addPath(europeanaAggregation);
    addPath(new DataElement("EuropeanaAggregation/edm:country",
      europeanaAggregation, "edm:country")
      .setActive(false));
    addPath(new DataElement("EuropeanaAggregation/edm:language",
