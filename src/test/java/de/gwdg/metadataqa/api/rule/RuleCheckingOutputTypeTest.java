...
public class RuleCheckingOutputTypeTest {
  ...
  public void testCreate() {
    assertEquals(RuleCheckingOutputStatus.NA, RuleCheckingOutputStatus.create(true, true, false));
    assertEquals(RuleCheckingOutputStatus.FAILED, RuleCheckingOutputStatus.create(true, false, false));
    assertEquals(RuleCheckingOutputStatus.PASSED, RuleCheckingOutputStatus.create(false, true, false));
    assertEquals(RuleCheckingOutputStatus.FAILED, RuleCheckingOutputStatus.create(false, false, false));
  }

  @Test
  public void negate_passed() {
    RuleCheckingOutputStatus type = RuleCheckingOutputStatus.create(false, true, false);
  ...
  public void negate_failed() {
    RuleCheckingOutputStatus type = RuleCheckingOutputStatus.create(false, false, false);
  ...
  public void negate_NA() {
    RuleCheckingOutputStatus type = RuleCheckingOutputStatus.create(true, false, false);
    assertEquals(RuleCheckingOutputStatus.FAILED, type);
    assertEquals(RuleCheckingOutputStatus.PASSED, type.negate());
  }
}
