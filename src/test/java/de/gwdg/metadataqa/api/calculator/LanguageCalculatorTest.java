...
public class LanguageCalculatorTest {
	...
	public void testGetLanguageMap() throws URISyntaxException, IOException {
		...
		assertNotNull(languages);
		assertEquals(33, languages.size());
